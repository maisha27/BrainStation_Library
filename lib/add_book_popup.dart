...
class AddBookPopup extends StatelessWidget {
  const AddBookPopup({Key? key}) : super(key: key);
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              /// Action Buttons
              _buildActionRow(context, "CANCEL", "ADD BOOK"),
              const SizedBox(height: 10),
              _buildActionRow(context, "CANCEL", "ADD PDF"),
              const SizedBox(height: 10),
              _buildActionRow(context, "CANCEL", "ADD SUMMARY"),
            ],
          ),
        ),
      ),
